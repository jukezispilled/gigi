  ...
  return (
    <div>
      <div className="banana-cursor h-[94vh] md:min-h-[97vh] w-screen flex justify-center items-center bg-cover bg-center relative overflow-clip z-10" style={{backgroundImage: `url(${process.env.PUBLIC_URL}/bg1.jpg)`}}>
        <div className=''>
          <div className='text-center font-custom font-bold -mt-[50%] md:-mt-[40%] mb-[10%]'>
            ...
            <h2 className='-mt-4 md:-mt-3 text-2xl md:text-4xl'>POWERED BY SOLANA</h2>
          </div>
          <motion.img 
            src={monkeyImage} 
            alt="Monkey" 
      ...
      <HorizontalTicker duration={10000}>
        <div className='h-16 flex items-center text-[30px] font-custom whitespace-nowrap border-y-2 border-black'>$DOGECAT $DOGECAT $DOGECAT $DOGECAT $DOGECAT $DOGECAT $DOGECAT $DOGECAT $DOGECAT $DOGECAT $DOGECAT $DOGECAT&nbsp;</div>
      </HorizontalTicker>
